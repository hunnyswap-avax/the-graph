...
import { Bundle, Burn, Mint, Pair, Swap, Token, Transaction } from '../../generated/schema'
import {
  Burn as BurnEvent,
  Mint as MintEvent,
...
export function onSync(event: SyncEvent): void {
  ...
  pair.reserveETH = pair.reserve0
    ...
    .plus(pair.reserve1.times(token1.derivedAVAX))
  ...
  // // use tracked amounts globally
  // factory.liquidityETH = factory.liquidityETH.plus(trackedLiquidityETH)
  // factory.liquidityUSD = factory.liquidityUSD.times(bundle.avaxPrice)
